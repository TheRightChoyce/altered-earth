  ...
  return (
    <div className="lg:pl-4 lg:basis-1/2">
      ...
      <div className="grid grid-cols-2 gap-y-0 mb-8 lg:grid-cols-4">
        ...
        <div className="text-md font-bold">Original</div>

        <h6 className="uppercase">Chakra</h6>
        <div className="text-md font-bold">{photo.attributes["Chakra"]}</div>

        <h6 className="uppercase">Season</h6>
        <div className="text-md font-bold">{photo.attributes["Season"]}</div>
      </div>

      <h4 className="text-2xl font-bold leading-relaxed">Details</h4>
      <div className="grid grid-cols-2 gap-y-0 mb-8 lg:grid-cols-4">
        <h6 className="uppercase">Token Id</h6>
        <div className="text-md font-bold">{photo.id}</div>
        ...
        <div className="text-md font-bold">image (JPG)</div>

        <h6 className="uppercase">Dimensions</h6>
        <div className="text-md font-bold">3024 x 4032</div>
        ...
        <div className="text-md font-bold">IPFS</div>
