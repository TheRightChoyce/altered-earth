...
export const GalleryDetailTokenInfo = ({
  ...
  return (
    <div className="text-center lg:pt-8">
      ...
      <h2 className="text-5xl font-bold custom-major-mono mb-12 lg:text-8xl lg:mb-16">
        <span className="block">the</span>
        <span className="block">HydrA</span>
        <span className="block">#{photo.id}</span>
      </h2>
      <p className="mt-4 text-lg italic leading-snug mb-8 lg:text-xl lg:mb-16 h-16">
        {photo.description}
      </p>
    </div>
  );
